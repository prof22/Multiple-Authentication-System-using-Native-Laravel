...
<head>
    ...
    <title>InfinityTech Course</title>
	...
	<!-- SPECIFIC CSS -->
    <link href="{{url('/')}}/asset/layerslider/css/layerslider.css" rel="stylesheet">
...
<body>
	...
	<header class="header menu_2">
		...
		<ul id="top_menu">
			...
			<li class="hidden_tablet"><a href="" class="btn_1 rounded">Admission</a></li>
		</ul>
		<!-- /top_menu -->
		...
		<nav id="menu" class="main-menu">
			<ul>
				...
				<li><span><a href="#0">Courses</a></span></li>
		...
		<div id="full-slider-wrapper">
			<div id="layerslider" style="width:100%;height:750px;">
				...
				<div class="ls-slide" data-ls="slidedelay: 5000; transition2d:85;">
					<img src="{{url('/')}}/asset/img/slides/slide_2.jpg" class="ls-bg" alt="Slide background">
				...
				<div class="ls-slide" data-ls="slidedelay:5000; transition2d:103;">
					<img src="{{url('/')}}/asset/img/slides/slide_3.jpg" class="ls-bg" alt="Slide background">
				...
				<div class="ls-slide" data-ls="slidedelay: 5000; transition2d:5;">
					<img src="{{url('/')}}/asset/img/slides/slide_1.jpg" class="ls-bg" alt="Slide background">
			...
			<div id="reccomended" class="owl-carousel owl-theme">
					...
					<div class="box_grid">
						<figure>
							...
							<a href="course-detail.html">
								<div class="preview"><span>Preview course</span></div><img src="{{url('/')}}/asset/img/course__list_1.jpg" class="img-fluid" alt=""></a>
				...
				<div class="item">
					<div class="box_grid">
						<figure>
							<a href="#0" class="wish_bt"></a>
							<a href="course-detail.html"><img src="{{url('/')}}/asset/img/course__list_2.jpg" class="img-fluid" alt=""></a>
				...
				<div class="item">
					<div class="box_grid">
						<figure>
							<a href="#0" class="wish_bt"></a>
							<a href="course-detail.html"><img src="{{url('/')}}/asset/img/course__list_3.jpg" class="img-fluid" alt=""></a>
				...
				<div class="item">
					<div class="box_grid">
						<figure>
							<a href="#0" class="wish_bt"></a>
							<a href="course-detail.html"><img src="{{url('/')}}/asset/img/course__list_4.jpg" class="img-fluid" alt=""></a>
				...
				<div class="item">
					<div class="box_grid">
						<figure>
							<a href="#0" class="wish_bt"></a>
							<a href="course-detail.html"><img src="{{url('/')}}/asset/img/course__list_5.jpg" class="img-fluid" alt=""></a>
				...
				<div class="item">
					<div class="box_grid">
						<figure>
							<a href="#0" class="wish_bt"></a>
							<a href="course-detail.html"><img src="{{url('/')}}/asset/img/course__list_6.jpg" class="img-fluid" alt=""></a>
							<div class="price">$54</div>
							<div class="preview"><span>Preview course</span></div>
						</figure>
						<div class="wrapper">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 wow" data-wow-offset="150">
					<a href="#0" class="grid_item">
						<figure class="block-reveal">
							<div class="block-horizzontal"></div>
							<img src="{{url('/')}}/asset/img/course_2.jpg" class="img-fluid" alt="">
							<div class="info">
				...
				<div class="col-lg-4 col-md-6 wow" data-wow-offset="150">
					<a href="#0" class="grid_item">
						<figure class="block-reveal">
							<div class="block-horizzontal"></div>
							<img src="{{url('/')}}/asset/img/course_3.jpg" class="img-fluid" alt="">
							<div class="info">
								<small><i class="ti-layers"></i>23 Programmes</small>
								<h3>Architecture</h3>
							</div>
				...
				<div class="col-lg-4 col-md-6 wow" data-wow-offset="150">
					<a href="#0" class="grid_item">
						<figure class="block-reveal">
							<div class="block-horizzontal"></div>
							<img src="{{url('/')}}/asset/img/course_4.jpg" class="img-fluid" alt="">
							<div class="info">
								<small><i class="ti-layers"></i>23 Programmes</small>
				...
				<div class="col-lg-4 col-md-6 wow" data-wow-offset="150">
					<a href="#0" class="grid_item">
						<figure class="block-reveal">
							<div class="block-horizzontal"></div>
							<img src="{{url('/')}}/asset/img/course_5.jpg" class="img-fluid" alt="">
							<div class="info">
								<small><i class="ti-layers"></i>23 Programmes</small>
				...
				<div class="col-lg-4 col-md-6 wow" data-wow-offset="150">
					<a href="#0" class="grid_item">
						<figure class="block-reveal">
							<div class="block-horizzontal"></div>
							<img src="{{url('/')}}/asset/img/course_6.jpg" class="img-fluid" alt="">
							<div class="info">
								<small><i class="ti-layers"></i>23 Programmes</small>
								<h3>Medical</h3>
							</div>
				...
				<div class="row">
					<div class="col-lg-6">
						<a class="box_news" href="#0">
							<figure><img src="{{url('/')}}/asset/img/news_home_1.jpg" alt="">
					...
					<div class="col-lg-6">
						<a class="box_news" href="#0">
							<figure><img src="{{url('/')}}/asset/img/news_home_2.jpg" alt="">
								<figcaption><strong>28</strong>Dec</figcaption>
							</figure>
							<ul>
								<li>Jhon Doe</li>
					...
					<div class="col-lg-6">
						<a class="box_news" href="#0">
							<figure><img src="{{url('/')}}/asset/img/news_home_3.jpg" alt="">
								<figcaption><strong>28</strong>Dec</figcaption>
							</figure>
							<ul>
								<li>Luca Robinson</li>
					...
					<div class="col-lg-6">
						<a class="box_news" href="#0">
							<figure><img src="{{url('/')}}/asset/img/news_home_4.jpg" alt="">
								<figcaption><strong>28</strong>Dec</figcaption>
							</figure>
							<ul>
		...
		<div class="container margin_120_95">
			<div class="row">
				<div class="col-lg-5 col-md-12 p-r-5">
					<p><img src="{{url('/')}}/asset/img/logo.png" width="149" height="42" data-retina="true" alt=""></p>
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div id="copy">© <?php echo date('Y');?> InfinityTechWorld</div>
				</div>
			</div>
		</div>
	</footer>
	...
	<!-- SPECIFIC SCRIPTS -->
    <script src="{{url('/')}}/asset/layerslider/js/greensock.js"></script>
    <script src="{{url('/')}}/asset/layerslider/js/layerslider.transitions.js"></script>
    <script src="{{url('/')}}/asset/layerslider/js/layerslider.kreaturamedia.jquery.js"></script>
    <script type="text/javascript">
        ...
        $('#layerslider').layerSlider({
            ...
            skinsPath: '{{url('/')}}/asset/layerslider/skins/'
